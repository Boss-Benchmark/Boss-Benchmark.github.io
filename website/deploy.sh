...
# GitHub Pages serves at https://boss-benchmark.github.io/
#
...
find . -maxdepth 1 -mindepth 1 \
  -not -name .git -not -name .github -not -name .gitignore \
  -not -name website -not -name .nojekyll -not -name README.md \
  -exec rm -rf {} +
